...
public class SystemUpdatePreferenceController extends BasePreferenceController {
    ...
    private static final String OTA_BUILD_TYPE_PROP = "ro.crystal.buildtype";
    private static final String OTA_APP_PACKAGE = "org.crystalos.updater";
    ...
    public int getAvailabilityStatus() {
        String buildtype = SystemProperties.get(OTA_BUILD_TYPE_PROP,"BIJOU");
        if (!mUm.isAdminUser() || !buildtype.equalsIgnoreCase("JEWEL")){
